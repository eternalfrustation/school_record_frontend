...
class SchoolDeletePage extends StatefulWidget {
  final int? id;
  const SchoolDeletePage({super.key, this.id});

  @override
  State<StatefulWidget> createState() => _SchoolDeletePageState();
}

class _SchoolDeletePageState extends State<SchoolDeletePage>
    with AfterLayoutMixin<SchoolDeletePage> {
